...
@Component({
  selector: 'app-line-chart-retraite',
  templateUrl: './line-chart-retraite.component.html',
  styleUrls: ['./line-chart-retraite.component.scss']
})
export class LineChartRetraiteComponent implements OnInit {
    ...
    this.data =[
      {
        ...
        key: 'Retraite', //key  - the name of the series.
